...
const modalFoooterPlus = document.querySelector('.modal-footer span');
...
const changeOpacity = x => {
    ...
    modalFoooterPlus.style.opacity = x;
};
...
toggle.addEventListener('click',()=>{
    ...
    Array.from(lightTexts).map((lightTxt) => lightTxt.classList.toggle('light'));
